...
Keep in mind that if your favourite R package for dataframes manipulation is [data.table]({{< siteurl >}}/data.table), functions *dcast* and *melt* are already in this package and work exactly the same as those in `reshape2`.
